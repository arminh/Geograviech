...
namespace Assets.Scripts
{
    class FightViechFactory: MonoBehaviour
    {
        ...
        private FightViech createAlraune(int level)
        {
            ...
            Attack scream = new Attack("Scream", ElementType.NORMAL, 3, 7, new StunEffect(70), null, level);
            Attack root = new Attack("The root of evil", ElementType.EARTH, 5, 3, null, null, level);
            Attack whining = new Attack("Unbearable Whining", ElementType.NORMAL, 8, 5, null, null, level);
            Attack beam = new Attack("Poison seeds", ElementType.EARTH, 2, 6, new PoisonEffect(50), null, level);
